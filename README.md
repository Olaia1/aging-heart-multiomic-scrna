...
The `report/` folder contains a LaTeX write-up of the full methodology (Overleaf-ready), with
dedicated slots for inserting figures and tables generated by the four analyses above, a
